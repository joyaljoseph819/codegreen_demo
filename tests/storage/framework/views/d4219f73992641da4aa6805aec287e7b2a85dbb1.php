...
<head>
    ...
    <body data-sa-theme="1">
        <div class="login">
            <div class="login__block active" id="login-div">
                <div class="login__block__header">
					...
					<span id="center_tt" class="alert_tooltip center_tt <?php echo e(session('authFailed.status') ?? ''); ?>" style="">Invalid Username or Password</span>
                </div>				
		...
		<script>
			if(<?php echo e(session('error.flag') ?? ''); ?>=='true'){
				alert('cad');
...
</html><?php /**PATH C:\wamp64\www\codegreen\resources\views/codegreen/login.blade.php ENDPATH**/ ?>