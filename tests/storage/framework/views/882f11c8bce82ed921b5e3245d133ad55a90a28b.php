        ...
        <div class="login">
            <div class="login__block active" id="login-div">
                <div class="login__block__header">
					...
					<span id="otp_error" class="alert_tooltip center_tt <?php echo e(session('otp_tt') ?? ''); ?>">Incorrect OTP</span>
...
</html><?php /**PATH C:\wamp64\www\codegreen\resources\views/codegreen/verify_otp.blade.php ENDPATH**/ ?>