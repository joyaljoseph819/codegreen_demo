...
<head>
    ...
    <body data-sa-theme="1">
							...
							<div class="media">
                                ...
                                <div class="media-body col-sm-6">
                                    ...
                                    <div class="form-group" data-toggle="tooltip" data-placement="bottom" title="Click on the Pencil Icon to Edit">
										...
										<div class="input-group">
											<input type="text" name="username" class="form-control" id="edit_username" onkeyup="edit_validate_dev_form('edit_username')" value="<?php echo e($user_name); ?>" placeholder="Username" readonly>										
                                ...
                                <div class="media-body col-sm-6">
                                    <div class="form-group" data-toggle="tooltip" data-placement="bottom" title="Click on the Pencil Icon to Edit">
                                        <label>Email</label>
										<div class="input-group">
											<input type="text" name="email" class="form-control" id="edit_email" onkeyup="edit_validate_dev_form('edit_email')" value="<?php echo e($user_email); ?>" placeholder="Email" readonly>										
                            ...
                            <div class="media">
                                ...
                                <div class="media-body col-sm-6">
                                    <div class="form-group" data-toggle="tooltip" data-placement="bottom" title="Click on the Pencil Icon to Edit">
                                        <label>D.O.B</label>
										<div class="input-group">
											<input type="text" name="dob" class="form-control input-mask" id="edit_dob" onkeyup="edit_validate_dev_form('edit_dob')" value="<?php echo e($user_dob); ?>" placeholder="D.O.B" data-mask="00-00-0000" autocomplete="off" maxlength="10" readonly>										
                                ...
                                <div class="media-body col-sm-6">
                                    <div class="form-group" data-toggle="tooltip" data-placement="bottom" title="Click on the Pencil Icon to Edit">
                                        <label>City</label>
										<div class="input-group">
											<input type="text" name="city" class="form-control" id="edit_city" onkeyup="edit_validate_dev_form('edit_city')" value="<?php echo e($user_city); ?>" placeholder="City" readonly>										
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/jquery/dist/jquery.mask.min.js')); ?>"></script>		
        ...
        <script type="text/javascript" src="<?php echo e(asset('js/validation.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('js/app.min.js')); ?>"></script>
    </body>
</html><?php /**PATH C:\wamp64\www\codegreen\resources\views/codegreen/edit_profile.blade.php ENDPATH**/ ?>